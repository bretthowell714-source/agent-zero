const settingsModalProxy = {
  ...
  async openModal() {
    ...
    try {
      ...
      window.toastFetchError('Error getting settings', _e);
    }
  },
  ...
  async handleButton(buttonId) {
    if (buttonId === 'save') {
      ...
      try {
        ...
        window.toastFetchError('Error saving settings', _e);
        return;
      }
    ...
    return {
      ...
      updateFilteredSections() {
        ...
        if (this.activeTab === 'agent') {
          ...
          this.filteredSections =
            this.settingsData.sections?.filter((section) => section.tab === 'backup') || [];
        } else {
